...
<body>
	...
	<div>
		<ul class="nav navbar-right" style="background-color: #FFFFFF">
			<li class="nav-item"><a class="nav-link" href="reg">Don't have an account? Register!</a>
		</ul>
		</div>
     		<div class="mx-auto w-40 p-3 text-center" style="background-color: #FFFFFF">
     		
  			<form method="POST" action="/greeting/loginProcess">
  			<h4>Login</h4>	
